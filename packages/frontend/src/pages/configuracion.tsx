...
export function ConfiguracionPage() {
  ...
  const updateMutation = useMutation({
    mutationFn: () =>
      api.updateConfig({
        anio: Number(currentAnio),
        iva: Number(currentIva),
  ...
  const handleExport = async () => {
    try {
      ...
      a.href = url
      a.download = `finza-${currentAnio}-export.json`
      a.click()
    ...
    <div className="flex flex-col gap-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Año fiscal, IVA y moneda</CardDescription>
        </CardHeader>
        <CardContent>
          <form
          ...
          >
            <div className="grid grid-cols-3 gap-4">
              <div className="flex flex-col gap-2">
                <Label htmlFor="cfg-anio">Año fiscal</Label>
                <Input
                  id="cfg-anio"
                  type="number"
                  value={currentAnio}
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Exportar, importar o resetear todos los datos</CardDescription>
        </CardHeader>
        <CardContent className="flex flex-col gap-4">
          ...
          <div>
            ...
            <p className="mt-2 text-xs text-muted-foreground">
              Elimina todas las transacciones, gastos fijos, ingresos fijos y catálogo. La configuración se mantiene.
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <AlertDialog open={resetConfirm} onOpenChange={setResetConfirm}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Esta acción eliminará TODAS las transacciones, gastos fijos, ingresos fijos, categorías, subcategorías y entidades.
              Solo se mantendrá la configuración. Esta acción NO se puede deshacer.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
